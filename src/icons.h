...
// LaMetric icon 2423 (humidity droplet). Baked in as PROGMEM because the
// source GIF is 6 identical static frames — no animation, no need for a
// GifPlayer instance (saves 10 KB RAM).
const uint16_t icon_2423[] = {
    0x0000, 0x0000, 0x0000, 0x32DF, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x32DF, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x19B3, 0x32DF, 0x32DF, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x19B3, 0x32DF, 0x32DF, 0x0000, 0x0000, 0x0000,
    0x0000, 0x19B3, 0x32DF, 0x32DF, 0xD6DF, 0x32DF, 0x0000, 0x0000,
    0x0000, 0x19B3, 0x32DF, 0x7C7C, 0xD6DF, 0x7C7C, 0x0000, 0x0000,
    0x0000, 0x19B3, 0x32DF, 0x7C7C, 0xD6DF, 0x7C7C, 0x0000, 0x0000,
    0x0000, 0x0000, 0x19B3, 0x32DF, 0x32DF, 0x0000, 0x0000, 0x0000,
};
#endif